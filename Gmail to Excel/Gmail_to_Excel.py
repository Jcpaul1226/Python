...
with open("credentials2.yml") as f:
    content = f.read()
...
worksheet.write(index,0,"Sender")
worksheet.write(index,1,"subject")
...
for msg in msgs[::-1]:
    for response_part in msg:
        if type(response_part) is tuple:
            ...
            worksheet.write(index+1,1, my_msg['subject'])
            worksheet.write(index+1,0, my_msg['from'])
            index += 1
